...
//	}
	...
	public static int dip2px(int dipValue) {
		float reSize = BaseApplication.getInstance().getResources().getDisplayMetrics().density;
	...
	public static float sp2px(int spValue) {
		return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, spValue, BaseApplication.getInstance().getResources().getDisplayMetrics());
	}
