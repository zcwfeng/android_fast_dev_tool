...
public class SettingUtility {
	...
	public static void setSettingUtility() {
        ...
        if (SdcardUtils.hasSdcardAndCanWrite()) {
            File rootFile = new File(BaseApplication.getInstance().getAppPath());
            if (!rootFile.exists())
                rootFile.mkdirs();
	...
	public static void addSettings(String settingsXmlName) {
		Map<String, Setting> newSettingMap = SettingsXmlParser.parseSettings(BaseApplication.getInstance(), settingsXmlName);
