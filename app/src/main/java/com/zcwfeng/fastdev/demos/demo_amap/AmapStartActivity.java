package com.zcwfeng.fastdev.demos.demo_amap;
...
import com.zcwfeng.fastdev.demos.demo_amap.view.FeatureView;
 ...
 * @类型名称: StartActivity
 */
public class AmapStartActivity extends ListActivity {
	public static void launch(Context from){
		Intent intent = new Intent(from,AmapStartActivity.class);
