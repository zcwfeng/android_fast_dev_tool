...
public class SlideHRecyclerViewTestActivity extends BaseActivity_deprecated {
    ...
    private void initviews() {
        ...
        adapter = new RecyclerAdapter(SlideHRecyclerViewTestActivity.this, lists);
        manager = new LinearLayoutManager(SlideHRecyclerViewTestActivity.this);
