...
class SnowFlake {
    ...
    private final Paint paint;
      ...
      static class Random {
          ...
          public static float getRandom(float feed){
              if(random == null)
                  random = new java.util.Random();
              return random.nextFloat() * feed;
         }


          public static float getRandom(float feed,float feed2){
              if(random == null)
                  random = new java.util.Random();
              return random.nextFloat() * (feed-feed2) + feed;
          }
    ...
    public static SnowFlake create(int width, int height, Paint paint) {
        ...
        int x = (int) random.getRandom(width);
    ...
    private void reset(int width) {
        position.x = (int) random.getRandom(width);
