...
import com.zcwfeng.fastdev.ui.widget.refresh.internal.ElasticOutInterpolator;
import com.zcwfeng.fastdev.ui.widget.refresh.internal.SimpleAnimatorListener;
import com.zcwfeng.fastdev.utils.UIUtils;
...
public class PullHeaderLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void setActionDrawable(Drawable actionDrawable) {
        ...
        if (mActionDrawable != null) {
            if (mActionView == null) {
                final int bgColor = UIUtils.getThemeColorFromAttrOrRes(getContext(), R.attr.colorAccent, R.color.colorAccent);
