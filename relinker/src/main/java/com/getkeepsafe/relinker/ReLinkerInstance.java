...
public class ReLinkerInstance {
  ...
  protected ReLinkerInstance(
      final ReLinker.LibraryLoader libraryLoader,
   ...
   * @return A {@link File} locating the directory that can store extracted libraries for later use
   */
   ...
   */
  protected File getWorkaroundLibFile(
      final Context context,
      final String library,
      final String version) {
   ...
   */
  protected void cleanupOldLibFiles(
      final Context context,
      final String library,
